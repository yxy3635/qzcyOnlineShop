...
?>
<div class="block" style="border-radius:12px;box-shadow:0 10px 30px rgba(17,24,39,.06);border:1px solid rgba(17,24,39,.06)">
     <div class="block-title" style="padding:10px 12px;border-bottom:1px solid rgba(17,24,39,.06)"><h2><?php echo ($zid>0?'分站ZID:<b>'.$zid.'</b> ':'全部分站')?>收支明细</h2></div>
