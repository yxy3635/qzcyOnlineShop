...
/* 顶部筛选区卡片化 */
.block{border-radius:12px;box-shadow:0 10px 30px rgba(17,24,39,.06);border:1px solid rgba(17,24,39,.06)}
.block-title{padding:10px 12px;border-bottom:1px solid rgba(17,24,39,.06)}
form.form-inline .form-control{margin-right:8px}
form.form-inline .btn{margin-right:6px}
</style>
<link href="../assets/appui/css/datepicker.css" rel="stylesheet">
<script src="../assets/js/bootstrap-datepicker-1.9.0.min.js"></script>
<script src="../assets/js/bootstrap-datepicker.zh-CN-1.9.0.min.js"></script>
...
<input type="hidden" name="uid" value="<?php echo @$_GET['uid']?>">
  <div class="form-group">
	...
	<select name="type" class="form-control"><option value="-1">全部状态</option><option value="0">待处理</option><option value="2">正在处理</option><option value="1">已完成</option><option value="3">异常</option><option value="4">已退单</option><option value="20">待考试</option><option value="21">平时分</option></select>
  </div>
  ...
  <a href="http://chake.qzcy3.top/" class="btn btn-default">快捷查单入口</a>
...
<script src="../assets/js/layer-3.1.1.js"></script>
