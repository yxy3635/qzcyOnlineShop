...
INSERT INTO `pre_config` VALUES ('gg_search', '<span class="label label-primary">已提交</span> 说明已经提交到服务器正在处理！<p></p><p></p><span class="label label-success">已完成</span> 已经提交到接口已经完成！<p></p><p></p><span class="label label-warning">处理中</span> 已经开始为您开单 请耐心等！<p></p><p></p><span class="label label-danger">有异常</span> 下单信息有误 联系客服处理！');
