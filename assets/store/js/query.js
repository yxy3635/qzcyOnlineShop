...
function showOrder(id,skey){
	...
	// 使用对象映射来处理状态显示
	var statusMap = {
		0: '<span class="label label-primary">已提交</span>',
		...
		4: '<font color=red>已退款</font>',
		20: '<span class="label label-info">待考试</span>',
		21: '<span class="label" style="background-color: #8B4513; color: white; padding: 2px 6px; border-radius: 3px;">平时分</span>'
	};
	$.ajax({
		type : "POST",
