...
$(document).ready(function() {
    // 简单的按钮点击反馈
    $(document).on('click', '.num1, .num3, .del', function() {
        var $this = $(this);
...
var GoodsCart = {
    ...
    PaySrtSucc: function (data) {
        ...
        $.each(data.data, function (key, val) {
            ...
            if (val.is_curl == 0) {
                var comm = '<span class="layui-badge" style="background-color: #009688">自动发货</span>';
            } else if (val.is_curl == 4) {
                var comm = '<span class="layui-badge " style="background-color: #FF9800">自动发货</span>';
            } else {
