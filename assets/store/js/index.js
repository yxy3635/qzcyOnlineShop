                ...
                ,done: function(page, next){ //执行下一页的回调
                    ...
                    success : function(res) {
                            ...
                            layui.each(res.data, function(index, item){
                                html = '<div class="fui-goods-item" style="width:33.33% !important;margin:0 !important;padding:.25rem !important;box-sizing:border-box !important;flex:0 0 33.33% !important;max-width:33.33% !important;">';
                                html += '<a title="'+item.name+'" href="./?mod=buy&tid='+item.tid+'" style="display:block;width:100%;">';
                                html += '<div class="image" style="width:100%;">';
                                if(!item.shopimg){
								...
								if(template_showsales == 1){
									html += '<div style="border-radius: 4px 0 0 4px;text-align:center;padding: 1px;background-color: rgb(57, 61, 73,0.5);color: #FFFFFF;text-align: center;font-size: 10px;position: absolute;right: 1px;bottom: 1px;"><i class="layui-icon layui-icon-fire" style="font-size:10px;"></i>销量'+item.sales+'</div>';
								}
