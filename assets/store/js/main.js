...
function getPoint() {
	...
	if(inputsname!=''){
		$.each(inputsname.split('|'), function(i, value) {
			...
			else if(value=='课程名'||value=='课程名称')
				var addstr='<div class="layui-btn layui-btn-sm layui-btn-normal btnee" id="iMeo5ckbutton" onclick="get_hzck(\'inputvalue'+(i+2)+'\',$(\'#inputvalue\').val(),$(\'#inputvalue2\').val(),$(\'#inputvalue3\').val(),$(\'#inputvalue4\').val(),$(\'#inputvalue5\').val(),\'hzck\')">获取课程</div>';
	...
	}else if($("#inputname4").html() == '课程名称：'||$("#inputname4").html() == '课程名：'){
		$('#inputvalue4').attr("placeholder", "输入信息后点击→");
		$("#inputvalue4").attr('disabled', true);
	}else if($("#inputname5").html() == '课程名称：'||$("#inputname5").html() == '课程名：'){
		$('#inputvalue5').attr("placeholder", "输入信息后点击→");
		$("#inputvalue5").attr('disabled', true);
