...
if($_GET['cid']){
	...
	// 如果没有指定分类，自动选择第一个可用分类
	var firstCid = $("#cid option:eq(1)").val();
	if(firstCid && firstCid != '0'){
		$("#cid").val(firstCid);
		$("#cid").change();
	}
}
