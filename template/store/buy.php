...
<head>
    ...
    <link href="<?php echo $cdnserver; ?>assets/css/sweetalert2-7.33.1.min.css" rel="stylesheet">
    <link href="<?php echo $cdnserver; ?>assets/css/animate-3.7.2.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?php echo $cdnserver; ?>assets/css/layui-2.5.7.css"/>
    <link href="<?php echo $cdnserver; ?>assets/css/swiper-4.5.1.min.css" rel="stylesheet">
    ...
    <div class="fui-page  fui-page-current " style="overflow: inherit">
        <div id="container" class="fui-content "
            ...
            <a href="javascript:;" onclick="goback();" class="left"
                ...
                <?php
                    if($tool['active'] == 0){
                        $msg = '<span class="pay_price">'.$price.'元</span><p id="submit_buys">已下架</p>';
                        $msg_style = "red";
                        $msg_fun = "layer.alert('当前课程已下架维护，停止下单！');";
                    }else if($tool['close'] == 1){
                        $msg = '<span class="pay_price">'.$price.'元</span><p id="submit_buys">维护中</p>';
                        $msg_style = "red";
                        $msg_fun = "layer.alert('当前课程维护中，停止下单！');";
                    }else if($isfaka == 1 && $count==0){
                        $msg = '<span class="pay_price">'.$price.'元</span><p id="submit_buys">缺货中</p>';
                        $msg_style = "red";
                        $msg_fun = "layer.alert('当前课程太过火爆，已经抢光啦！');";
                    }else{
...
<script src="<?php echo $cdnserver; ?>assets/js/swiper-4.5.1.min.js"></script>
<script src="<?php echo $cdnserver; ?>assets/js/sweetalert2-7.33.1.min.js"></script>
<script>
